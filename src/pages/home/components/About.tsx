  ...
  return (
    ...
    >
      <Box
        ...
        bg="#E2E8F0"
      />
      <Container minH={{ lg: '100vh' }} p="12" py={{ lg: '20' }}>
        <Heading
          textAlign="center"
        ...
        <Box display="flex" justifyContent="space-around" alignItems="center" gap="8">
          ...
          >
            <Text fontSize={{ lgDown: 'md', lg: 'lg' }}>
              A gente acredita que, com orientação e espaço pra trocar experiências, qualquer pessoa
              pode desenvolver soluções reais e fazer parte do mundo digital — mesmo começando do
              zero.
            </Text>
          </Card.Root>
        </Box>
